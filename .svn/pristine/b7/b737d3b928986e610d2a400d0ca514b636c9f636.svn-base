...
public class Constants {
    ...
    public static final String QQ_CHATSETTING = "com.tencent.mobileqq/.activity.ChatSettingForTroop";
    ...
    // 回復消息
    public static final int TYPE_REPLY_MESSAGE_TASK = 13;
    // 還原
    ...
    // 发群消息
    public static final int TYPE_MASSMSG_TASK = 6;
    // 关闭通知
...
//    /*还原 */
//    public static final int TYPE_REDUCTIONDATA_TASK = 5;
//    /*备份*/
//    public static final int TYPE_BACKUPS_TASK = 4;
//    /* 站街 */
//    public static final int TYPE_NEARBY_TASK = 17;
//    /* 修改个人信息*/
//    public static final int TYPE_MODIFYINFO_TASK = 2;
//    /* 朋友圈*/
//    public static final int TYPE_FRIENDSCIRCLE_TASK = 6;
//    public static final int TYPE_SHARED_CIRCLE_SALE = 11;
//    /* 回复新招呼消息*/
//    public static final int TYPE_MESSAGEREPLY_TASK = 8;
//    /* 设置*/
//    public static final int TYPE_SETTINGS_TASK = 29;
//    /* 删除朋友圈*/
//    public static final int TYPE_FRIENDSCIRCLE_DELETE_TASK = 20;
//    /*清空缓存*/
//    public static final int TYPE_WIPECACHE_TASK = 9;
